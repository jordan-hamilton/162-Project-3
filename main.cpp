...
*/
  ...
  Barbarian newBarb;
  std::cout << "Number of Attack Dice: " << newBarb.getNumAttackDice() << std::endl;
  std::cout << "Number of Attack Die Sides: " << newBarb.getNumAttackDieSides() << std::endl;
  std::cout << "Number of Defense Dice: " << newBarb.getNumDefenseDice() << std::endl;
  std::cout << "Number of Defense Die Sides: " << newBarb.getNumDefenseDieSides() << std::endl;
  std::cout << "Strength: " << newBarb.getStrengthPts() << std::endl;
  std::cout << "Armor: " << newBarb.getArmorPts() << std::endl;
  std::cout << "Characteristics: " << newBarb.getCharacteristics() << std::endl;
  std::cout << "Defense: " << newBarb.getDefensePts() << std::endl;
  std::cout << "Attack: " << newBarb.getDefensePts() << std::endl;
  std::cout << "Calling attack: " << newBarb.attack() << std::endl;
  std::cout << "Attack points: " << newBarb.getAttackPts() << std::endl;
  std::cout << "Calling attack again: " << newBarb.attack() << std::endl;
  std::cout << "Attack points: " << newBarb.getAttackPts() << std::endl;
  std::cout << "Using the last attack, then defending and returning the defense points: " << newBarb.defend( newBarb.getAttackPts() ) << std::endl;
  std::cout << "Updated strength: " << newBarb.getStrengthPts() << std::endl;
  return 0;
